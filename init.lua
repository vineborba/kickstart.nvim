...
require('lazy').setup({
  ...
  -- NOTE: The import below can automatically add your own plugins, configuration, etc from `lua/vin/plugins/*.lua`
  --    This is the easiest way to modularize your config.
  --
  --  Uncomment the following line and add your plugins to `lua/vini/plugins/*.lua` to get going.
  { import = 'vini.plugins' },
  --
